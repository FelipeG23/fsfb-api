...
public class ResultadoCitaDto {

    private Long idCita;
    private Long pacNum;
    private String valorPrestacional;
    ...
    private String letraCodCentroAten;
    ...
    public String getValorPrestacional() {
        return valorPrestacional;
    }

    public void setValorPrestacional(String valorPrestacional) {
    ...
    public String getDireccionCentroOperativo() {
        return direccionCentroOperativo;
    }
    ...
    public String getTelefonoCentroOperativo() {
        return telefonoCentroOperativo;
    }
    ...
    public String getLetraCodCentroAten() {
        return letraCodCentroAten;
    }

    public void setLetraCodCentroAten(String letraCodCentroAten) {
        this.letraCodCentroAten = letraCodCentroAten;
    }
